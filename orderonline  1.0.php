	...
	<div id="header" class="container">
		...
		<div id="menu">
			<ul>
				...
				<li><a href="http://localhost/create.php" accesskey="5" title="">Join Us</a></li>
			</ul>
		</div>
	</div>
</div>
...
<div id="product-grid">
	...
	?>
		<div class="product-item">
			...
			target="popup"
			onclick="window.open(get-product-info.php?id=<?php echo $product_array[$key]["id"] ?>','popup','width=600,height=6000');return false;">
...
<footer>
  <p>Posted by: Luca's bread</p >
  <p>Contact information:Luca bread@qq.com</ a>.</p >
</footer>
